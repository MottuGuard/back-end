...
public class MotoController {
    ...
    @PostMapping("/adicionarMoto/{id}")
    public ResponseEntity adicionarMoto(@RequestBody MotoDTO dto, @PathVariable Long id) {
        MotoDTO motoToAdd = motoService.salvarMoto(dto, id);
